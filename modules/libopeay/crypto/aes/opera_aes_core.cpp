...
#if defined(_SSL_USE_OPENSSL_) || defined(LIBOPEAY_ENCRYPTION_AES_SUPPORT)
# if !defined(_USE_SYSTEM_LIBCRYPTO_)
extern "C" {
#include "modules/libopeay/openssl/cryptlib.h"
#include "modules/libopeay/crypto/aes/aes_core.c"
}
# endif // !_USE_SYSTEM_LIBCRYPTO_
#endif // _SSL_USE_OPENSSL_ || defined(LIBOPEAY_ENCRYPTION_AES_SUPPORT)
