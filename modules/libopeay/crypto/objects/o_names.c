...
OPENSSL_IMPLEMENT_GLOBAL(LHASH_OF(OBJ_NAME) *, names_lh);
#define names_lh OPENSSL_GLOBAL_REF(names_lh)
#else
...
#ifdef OPERA_SMALL_VERSION
OPENSSL_IMPLEMENT_GLOBAL(STACK_OF(NAME_FUNCS) *, name_funcs_stack);
#define name_funcs_stack OPENSSL_GLOBAL_REF(name_funcs_stack)
#else
...
static int do_all_sorted_cmp(const void *n1_,const void *n2_)
	...
	return op_strcmp((*n1)->name,(*n2)->name);
	}
...
void OBJ_NAME_do_all_sorted(int type,void (*fn)(const OBJ_NAME *,void *arg),
	...
	op_qsort((void *)d.names,d.n,sizeof *d.names,do_all_sorted_cmp);
...
#ifdef OPERA_SMALL_VERSION
OPENSSL_IMPLEMENT_GLOBAL(int, free_type);
#define free_type OPENSSL_GLOBAL_REF(free_type)
#else
static int free_type=0;
#endif
