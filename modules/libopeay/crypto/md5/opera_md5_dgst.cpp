...
#if defined(_SSL_USE_OPENSSL_) || defined(LIBOPEAY_HASH_MD5_SUPPORT)
# if !defined(_USE_SYSTEM_LIBCRYPTO_)
extern "C" {
#include "modules/libopeay/openssl/cryptlib.h"
#include "modules/libopeay/crypto/md5/md5_dgst.c"
}
# endif // !_USE_SYSTEM_LIBCRYPTO_
#endif // _SSL_USE_OPENSSL_ || defined(LIBOPEAY_HASH_MD5_SUPPORT)
