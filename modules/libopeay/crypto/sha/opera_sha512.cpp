...
#if defined(_SSL_USE_OPENSSL_) || defined(LIBOPEAY_HASH_SHA512_SUPPORT)
# if !defined(_USE_SYSTEM_LIBCRYPTO_)
extern "C" {
#include "modules/libopeay/openssl/cryptlib.h"
#include "modules/libopeay/crypto/sha/sha512.c"
}
# endif // !_USE_SYSTEM_LIBCRYPTO_
#endif // _SSL_USE_OPENSSL_ || defined(LIBOPEAY_HASH_SHA512_SUPPORT)
