...
typedef struct ubsec_crypto_context_s {
	unsigned int	flags;
	unsigned char	crypto[MAX_CRYPTO_KEY_LENGTH]; /* ARRAY OK 20092005 yngve Unused file */
	unsigned char 	auth[MAX_MAC_KEY_LENGTH];	 /* ARRAY OK 20092005 yngve Unused file */
