...
#ifndef OPREA_STDLIB_LOCALMATH_H
#define OPREA_STDLIB_LOCALMATH_H
...
#else
# define set_errno(x) (void)(0)
#endif

#ifndef HUGE_VAL
# define HUGE_VAL g_stdlib_infinity
#endif

#endif // OPREA_STDLIB_LOCALMATH_H
