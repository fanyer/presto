...
#include "modules/spellchecker/hunspell_3p/src/hunspell/affixmgr.h"
...
private:
#ifdef MORPHOLOGICAL_FUNCTIONS
  int    cleanword(char *, size_t size, const char *, int * pcaptype, int * pabbrev);
#endif
   int    cleanword2(char *, size_t size, const char *, w_char *, int * w_len, int * pcaptype, int * pabbrev);
   void   mkinitcap(char * p, size_t size);
   int    mkinitcap2(char * p, size_t size, w_char * u, int nc);
   int    mkinitsmall2(char * p, size_t size, w_char * u, int nc);
   void   mkallcap(char *, size_t size);
   int    mkallcap2(char * p, size_t size, w_char * u, int nc);
   void   mkallsmall(char *);
   int    mkallsmall2(char * p, size_t size, w_char * u, int nc);
   ...
   void   cat_result(char * result, size_t size, char * st);
