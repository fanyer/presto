...
#include "modules/libfreetype/src/smooth/ftsmooth.h"
...
#ifndef OPERA_FT_USE_SUBPIXEL_RENDERING
# error "compiling patented code! please undef FT_CONFIG_OPTION_SUBPIXEL_RENDERING"
