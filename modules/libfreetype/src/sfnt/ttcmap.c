...
#include "modules/libfreetype/src/sfnt/sferrors.h"           /* must come before FT_INTERNAL_VALIDATE_H */

#include FT_INTERNAL_VALIDATE_H
#include FT_INTERNAL_STREAM_H
#include "modules/libfreetype/src/sfnt/ttload.h"
#include "modules/libfreetype/src/sfnt/ttcmap.h"
#include "modules/libfreetype/src/sfnt/sfntpic.h"
...
#include "modules/libfreetype/src/sfnt/ttcmapc.h"
    NULL,
  };
...
#include "modules/libfreetype/src/sfnt/ttcmapc.h"
    ...
    if ( FT_ALLOC( clazz, sizeof(TT_CMap_Class)*(i+1)+sizeof(TT_CMap_ClassRec)*i ) )
      return error;
