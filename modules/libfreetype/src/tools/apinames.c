...
#include "modules/libfreetype/include/stdio.h"
#include "modules/libfreetype/include/stdlib.h"
#include "modules/libfreetype/include/string.h"
#include "modules/libfreetype/include/ctype.h"
    ...
    case OUTPUT_WATCOM_LBC:
      {
        ...
        char         temp[512]; // ARRAY OK 2012-12-15 ed
        const char*  dot;
...
{
  static char  buff[ LINEBUFF_SIZE+1 ]; /* ARRAY OK 2011-12-15 ed */
