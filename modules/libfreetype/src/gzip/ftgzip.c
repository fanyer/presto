...
# ifdef OPERA_FT_CONFIG_OPTION_ZLIB_HEADER_PATH
#  include OPERA_FT_CONFIG_OPTION_ZLIB_HEADER_PATH
# else
#  include <zlib.h>
# endif // OPERA_FT_CONFIG_OPTION_ZLIB_HEADER_PATH
