...
typedef struct {
  ...
  float PSNR[5];          // peak-signal-to-noise ratio for Y/U/V/All/Alpha // ARRAY OK 2012-08-22
  int block_count[3];     // number of intra4/intra16/skipped macroblocks // ARRAY OK 2012-08-22
  int header_bytes[2];    // approximate number of bytes spent for header // ARRAY OK 2012-08-22
                          // and mode-partition #0
  int residual_bytes[3][4];  // approximate number of bytes spent for // ARRAY OK 2012-08-22
                             // DC/AC/uv coefficients for each (0..3) segments.
  int segment_size[4];    // number of macroblocks in each segments // ARRAY OK 2012-08-22
  int segment_quant[4];   // quantizer values for each segments // ARRAY OK 2012-08-22
  int segment_level[4];   // filtering strength for each segments [0..63] // ARRAY OK 2012-08-22
