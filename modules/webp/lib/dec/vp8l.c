...
#include "modules/webp/lib/dec/vp8li.h"
#include "modules/webp/lib/dsp/lossless.h"
#include "modules/webp/lib/dsp/yuv.h"
#include "modules/webp/lib/utils/huffman.h"
#include "modules/webp/lib/utils/utils.h"
...
static int ReadHuffmanCode(int alphabet_size, VP8LDecoder* const dec,
  ...
  if (simple_code) {  // Read symbols, codes & code lengths directly.
    int symbols[2]; // ARRAY OK 2012-08-22 andersr
    int codes[2]; // ARRAY OK 2012-08-22 andersr
    int code_lengths[2]; // ARRAY OK 2012-08-22 andersr
    int num_symbols = VP8LReadBits(br, 1) + 1;
    ...
    num_symbols = num_symbols > 2 ? 2 : num_symbols;
    ok = HuffmanTreeBuildExplicit(tree, code_lengths, codes, symbols,
                                  alphabet_size, num_symbols);
  } else {  // Decode Huffman-coded code lengths.
    int* code_lengths = NULL;
    int i;
    int code_length_code_lengths[NUM_CODE_LENGTH_CODES] = { 0 }; // ARRAY OK 2012-08-22 andersr
...
VP8LDecoder* VP8LNew(void) {
  VP8LDecoder* const dec = (VP8LDecoder*)vp8_calloc(1, sizeof(*dec));
