 ...
 *
 * Copyright (C) Opera Software ASA  1999-2012
 *
...
#define NEEDS_RISC_ALIGNMENT
#endif

#if defined(ARCHITECTURE_AMD64) || defined(MSWIN)
#define STDLIB_SIXTY_FOUR_BIT_TIME_T 1
#endif

#define OPSYSTEMINFO_CPU_FEATURES
#define OP_EXTERN_C extern "C"

#include "modules/ecmascript/ecmascript_capabilities.h"
#include "modules/regexp/regexp_capabilities.h"
...
#ifdef ECMASCRIPT_STANDALONE_COMPILER
#  ifdef _DEBUG
#    define ECMASCRIPT_DISASSEMBLER
#  endif
#endif
#define ECMASCRIPT_DECOMPILER
#define ECMASCRIPT_DEBUGINFO
#define ES_EXECUTE_SUPPORT
#define ES_OPPSEUDOTHREAD

#define OPMEMORY_EXECUTABLE_SEGMENT
#define OPMEMORY_STACK_SEGMENT
#define OPMEMORY_ALIGNED_SEGMENT
...
# include "modules/ecmascript/carakan/ecmascript_module.h"
#endif // !HTML5_STANDALONE
#include "modules/regexp/regexp_module.h"
...
#ifdef ECMASCRIPT_MODULE_REQUIRED
	EcmaScriptModule ecmascript_module;
#endif
#ifdef REGEXP_MODULE_REQUIRED
	RegexpModule regexp_module;
#endif
