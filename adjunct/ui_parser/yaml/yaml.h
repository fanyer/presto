...
/** The tag @c !!merge is used to denote a merge. */
#define YAML_MERGE_TAG		"tag:opera.com,2010:merge"
...
/** The default merge tag is @c !!merge. */
#define YAML_DEFAULT_MERGE_TAG		YAML_MERGE_TAG
