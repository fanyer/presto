...
#include "platforms/media_backends/gst/include/glib/gutils.h"        /* for G_INLINE_FUNC */
#include "platforms/media_backends/gst/include/glib/gatomic.h"       /* for g_atomic_pointer_get */
